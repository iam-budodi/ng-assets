...
@Component({
  selector: 'search-date-table',
  templateUrl: './search-date-table.component.html',
  styleUrls: ['./search-date-table.component.css']
})
export class SearchDateTableComponent implements OnInit, AfterViewInit {
