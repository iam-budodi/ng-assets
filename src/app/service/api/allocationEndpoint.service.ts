...
export class AllocationEndpointService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public restAllocationsAllocationIdGet(allocationId: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<Array<Allocation>>;
    public restAllocationsAllocationIdGet(allocationId: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<Array<Allocation>>>;
    public restAllocationsAllocationIdGet(allocationId: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<Array<Allocation>>>;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public restAllocationsEmployeeIdGet(employeeId: number, status?: AllocationStatus, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<Array<EmployeeAsset>>;
    public restAllocationsEmployeeIdGet(employeeId: number, status?: AllocationStatus, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<Array<EmployeeAsset>>>;
    public restAllocationsEmployeeIdGet(employeeId: number, status?: AllocationStatus, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<Array<EmployeeAsset>>>;
    public restAllocationsEmployeeIdGet(employeeId: number, status?: AllocationStatus, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (employeeId === null || employeeId === undefined) {
            throw new Error('Required parameter employeeId was null or undefined when calling restAllocationsEmployeeIdGet.');
        }
        ...
        let localVarPath = `/rest/allocations/${this.configuration.encodeParam({name: "employeeId", value: employeeId, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int64"})}`;
