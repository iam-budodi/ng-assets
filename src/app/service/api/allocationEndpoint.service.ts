...
export class AllocationEndpointService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public restAllocationsAssetsGet(workId: string, status?: AllocationStatus, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<Array<EmployeeAsset>>>;
    public restAllocationsAssetsGet(workId: string, status?: AllocationStatus, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<Array<EmployeeAsset>>;
    public restAllocationsAssetsGet(workId: string, status?: AllocationStatus, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<Array<EmployeeAsset>>>;
    public restAllocationsAssetsGet(workId: string, status?: AllocationStatus, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
