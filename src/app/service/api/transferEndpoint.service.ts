...
export class TransferEndpointService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public restTransfersTransferIdGet(transferId: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<Array<Transfer>>;
    public restTransfersTransferIdGet(transferId: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<Array<Transfer>>>;
    public restTransfersTransferIdGet(transferId: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<Array<Transfer>>>;
