...
export class EmployeeEndpointService {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public restEmployeesReportGet(end?: string, start?: string, observe?: 'body', reportProgress?: boolean, options?: {
    httpHeaderAccept?: 'application/json',
    context?: HttpContext
  }): Observable<Array<Employee>>;

  public restEmployeesReportGet(end?: string, start?: string, observe?: 'response', reportProgress?: boolean, options?: {
    httpHeaderAccept?: 'application/json',
    context?: HttpContext
  }): Observable<HttpResponse<Array<Employee>>>;

  public restEmployeesReportGet(end?: string, start?: string, observe?: 'events', reportProgress?: boolean, options?: {
    httpHeaderAccept?: 'application/json',
    context?: HttpContext
  }): Observable<HttpEvent<Array<Employee>>>;

  public restEmployeesReportGet(end?: string, start?: string, observe: any = 'body', reportProgress: boolean = false, options?: {
    httpHeaderAccept?: 'application/json',
    context?: HttpContext
  }): Observable<any> {
