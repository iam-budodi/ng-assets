...
export const APIS = [AllocationEndpointService, CategoryEndpointService, CollegeEndpointService, ComputerEndpointService, DepartmentEndpointService, EmployeeEndpointService, MicroProfileHealthService, PurchaseEndpointService, QRCodePreviewEndpointService, SupplierEndpointService, TransferEndpointService];
