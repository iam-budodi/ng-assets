...
export const APIS = [AllocationEndpointService, CategoryEndpointService, ComputerEndpointService, DepartmentEndpointService, EmployeeEndpointService, MicroProfileHealthService, PurchaseEndpointService, QRCodePreviewEndpointService, SupplierEndpointService, TransferEndpointService];
