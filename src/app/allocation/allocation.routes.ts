...
export const allocationRoutes: Routes = [
  {path: 'allocations', component: AssignListComponent},
  {path: 'allocations/:id', component: QrDetailsComponent, resolve: {allocation: allocationResolver}},
  {path: 'transfers', component: TransferListComponent},
  {path: 'transfers/:id', component: QrTransferDetailsComponent, resolve: {transfer: transferResolver}},
  {path: 'qr-preview', component: QrPreviewComponent}
]
